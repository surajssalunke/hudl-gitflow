...
import PRCommmitActivity from "../squadMetrics/pRCommitActivity";
import CycleTimeMetrics from "../squadMetrics/pRCycleTimeMetrics";
import ReviewMetrics from "../squadMetrics/reviewMetricsPerRepoCard";
    ...
    const fetchInsights = async () => {
      ...
      try {
        const payload = {
          ...
          to: dateRange.end,
          member: member || localStorage.getItem("github_username") || "",
        };
